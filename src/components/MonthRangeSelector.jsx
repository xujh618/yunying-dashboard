...
const MonthRangeSelector = ({ selectedMonth, onMonthChange }) => {
  // 生成从2025年1月到当前月份的选项
  ...
  return (
    <div className="flex items-center space-x-4 bg-white/10 backdrop-blur-md rounded-xl p-4 shadow-lg">
      ...
      >
        <option value="" className="bg-blue-900">全部月份</option>
